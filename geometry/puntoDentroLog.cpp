...
int main() {
    // Definir el polígono convexo
    vector<pt> polygon = {pt(0, 0), pt(4, 0), pt(4, 4), pt(0, 4)};
    
    // Preparar la estructura para el polígono convexo
    prepare(polygon);

    // Definir algunos puntos de prueba
    vector<pt> testPoints = {pt(2, 2), pt(5, 5), pt(0, 0), pt(4, 4), pt(2, 0)};
    
    // Probar si los puntos están dentro del polígono convexo
